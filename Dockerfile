...
# Decisão: Next.js para frontend usuário (conforme 2.Architecture.md seção 3.1)
...
# Instalar dependências baseadas no package.json e package-lock.json preferencialmente
